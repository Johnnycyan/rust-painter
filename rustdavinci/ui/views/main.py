...
class MainWindow(QMainWindow):
    ...
    def expand_window(self):
        ...
        # Add Update button
        self.update_quality_button = QPushButton(
            "Update Preview", self.quality_container
        )
    ...
    def apply_quality_update(self):
        ...
        if (
            self.rustDaVinci.pixmap_on_display == 1
            and hasattr(self.rustDaVinci, "org_img")
            and self.rustDaVinci.org_img is not None
        ):
            ...
            self.ui.log_TextEdit.append(
                f"Updating preview with {value}% color merge quality..."
            )
