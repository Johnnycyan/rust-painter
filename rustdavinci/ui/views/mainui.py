...
class Ui_MainUI(object):
    def setupUi(self, MainUI):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(":/icons/RustDaVinci-icon.ico"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(":/icons/load_image_icon.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(
            QtGui.QPixmap(":/icons/select_area_icon.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(
            QtGui.QPixmap(":/icons/settings_icon.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
    ...
    def retranslateUi(self, MainUI):
        ...
        self.load_image_PushButton.setToolTip(
            _translate("MainUI", "Load Image from File or URL")
        )
        self.load_image_PushButton.setText(
            _translate("MainUI", "         Load Image...        ")
        )
        self.identify_ctrl_PushButton.setToolTip(
            _translate(
                "MainUI", "Capture the painting control area manually or automatically"
            )
        )
        self.identify_ctrl_PushButton.setText(
            _translate("MainUI", " Capture Control Area...")
        )
        self.paint_image_PushButton.setToolTip(_translate("MainUI", "Paint the Image"))
        self.paint_image_PushButton.setText(
            _translate("MainUI", "         Paint Image           ")
        )
        self.settings_PushButton.setToolTip(
            _translate("MainUI", "Show Rust Painter Settings")
        )
        self.settings_PushButton.setText(
            _translate("MainUI", "            Settings              ")
        )
        self.preview_PushButton.setToolTip(
            _translate(
                "MainUI", "Show Original Image and Preview of the Quantized Images"
            )
        )
        ...
        self.timeStatusLabel.setText(
            _translate("MainUI", "Time: 00:00:00 | Remaining: 00:00:00")
        )
